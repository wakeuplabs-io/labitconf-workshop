import { labitConfTokenAbi } from "../shared/abis";
import { PublicClient, WalletClient, Address } from "viem";
import { ZERO_ADDRESS } from "../shared/constants";

/**
 * A service class for interacting with the LabitConf token contract.
 */
export class LabitConfTokenService {
  private publicClient: PublicClient;
  private ownerClient: WalletClient;
  private address: Address;
  private abi = labitConfTokenAbi;
   ...
   */
  setOwnerClient(ownerClient: WalletClient) {
